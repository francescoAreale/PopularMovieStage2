...
import static reale.francesco.com.popularmovie.data.MovieContract.MovieEntry.TABLE_NAME;
...
public class MovieContentProvider extends ContentProvider {
    ...
    private  MovieDbHelper datab;


    @Override
    public boolean onCreate() {
        Context context = getContext();
        datab = new MovieDbHelper(context);
        return true;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        final SQLiteDatabase db = datab.getReadableDatabase();
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        final SQLiteDatabase db = datab.getWritableDatabase();
